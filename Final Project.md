...
<div align=center><a href="http://www.codecogs.com/eqnedit.php?latex=E\left&space;(&space;\overline{x}&space;\right&space;)=E\left&space;(&space;\&space;\frac{1}{N}\sum_{i=1}^{N}x_{i}\right&space;)=E\left&space;(&space;\&space;\frac{1}{N}\sum_{i=1}^{N}\sum_{j=1}^{n}s_{ij}\right&space;)=\frac{1}{N}NnE\left&space;(&space;s&space;\right&space;)=n\left&space;[&space;\frac{1}{2}\times&space;1&plus;\frac{1}{2}\times&space;\left&space;(&space;-1&space;\right&space;)&space;\right&space;]=0" target="_blank"><img src="http://latex.codecogs.com/gif.latex?E\left&space;(&space;\overline{x}&space;\right&space;)=E\left&space;(&space;\&space;\frac{1}{N}\sum_{i=1}^{N}x_{i}\right&space;)=E\left&space;(&space;\&space;\frac{1}{N}\sum_{i=1}^{N}\sum_{j=1}^{n}s_{ij}\right&space;)=\frac{1}{N}NnE\left&space;(&space;s&space;\right&space;)=n\left&space;[&space;\frac{1}{2}\times&space;1&plus;\frac{1}{2}\times&space;\left&space;(&space;-1&space;\right&space;)&space;\right&space;]=0" title="E\left ( \overline{x} \right )=E\left ( \ \frac{1}{N}\sum_{i=1}^{N}x_{i}\right )=E\left ( \ \frac{1}{N}\sum_{i=1}^{N}\sum_{j=1}^{n}s_{ij}\right )=\frac{1}{N}NnE\left ( s \right )=n\left [ \frac{1}{2}\times 1+\frac{1}{2}\times \left ( -1 \right ) \right ]=0" /></a></div>
